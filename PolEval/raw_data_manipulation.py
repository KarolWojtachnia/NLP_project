...
with open('raw_data/training_set_clean_only_text.txt', 'r', encoding='utf-8') as tags:
...
# Save Y.npy
with open('raw_data/training_set_clean_only_tags.txt', 'r', encoding='utf-8') as tags:
    content = tags.readlines()
    for line in content:
...
with open('raw_data/test_set_clean_only_text.txt', 'r', encoding='utf-8') as tags:
    content = tags.readlines()
...
with open('raw_data/test_set_clean_only_tags.txt', 'r', encoding='utf-8') as tags:
    content = tags.readlines()
    for line in content:
